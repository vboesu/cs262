...
class Request:
    ...
    def __repr__(self) -> str:
        return f"<Request header_cls={self.header_cls.__name__} request_code={self.request_code} request_id={self.request_id} addr={self.addr}>"
    ...
    @classmethod
    def receive(cls, sock: socket.socket, addr: str) -> "Request":
        """
        ...
        return Request(header.request_code, decoded, header.request_id, addr)
